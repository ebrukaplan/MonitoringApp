    ...
    public class MonitoringAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Application>().HasData(
                ...
                new Application { ApplicationId = 3, ApplicationName = "Stackoverflow", ApplicationUrl = "https://stackoverflow.co/explore-teams/?utm_source=adwords&utm_medium=ppc&utm_campaign=kb_teams_search_nb_dsa_targeted_audiences_emea-dach&_bt=646019453177&_bk=&_bm=&_bn=g&gclid=EAIaIQobChMI46KLhaGh_gIVjplRCh18BQVdEAAYASAAEgLIA_D_BwE", CreatedDate = DateTime.Now, CreatedBy = 1, IntegrationTypeId = 1, isDown = false, isNotified = false, NotifyList = "", MonitorInterval = 60 },
